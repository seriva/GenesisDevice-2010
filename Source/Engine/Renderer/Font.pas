...
type
  ...
  public
    ...
    procedure   Render( aR, aG, aB, aLeft, aTop, aScale : Double; aString : string);
...
constructor TFont.Create(aTexture : string);
begin
  FTexture := TTexture( Engine.Resources.Load( aTexture ));
end;

destructor TFont.Destroy();
begin
  inherited;
  Engine.Resources.Remove(TResource(FTexture));
end;

function TFont.TextWidth(const str : String; const scale : Single = 1): Integer;
var
...
Procedure TFont.Render( aR, aG, aB, aLeft, aTop, aScale : Double; aString : string);
var
...
begin
  Engine.Renderer.FontShader.Bind();
  Engine.Renderer.FontShader.SetInt('texture0', 0);
  Engine.Renderer.FontShader.SetFloat4('color', aR, aG, aB, 1);
